...
**/
class FNFTransition extends forever.music.MusicBeat.MusicBeatSubState {
	...
	public function new(duration:Float, isTransIn:Bool) {
		...
		transGradient = flixel.util.FlxGradient.createGradientFlxSprite(width, height, (isTransIn ? [0x0, FlxColor.BLACK] : [FlxColor.BLACK, 0x0]));
