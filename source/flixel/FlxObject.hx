 ...
 * - Utility function to check if the `FlxObject` is overlaped
 * - Set `moves` to false by default for huge performance improvement
 */
/**
...
class FlxObject extends FlxBasic
{
	...
	/**
	 * Set this to `true` if you want the automatic motion/movement stuff (see `updateMotion()`).
	 */
    ...
    /**
     * Utility function to check if this `FlxObject` is overlaped.
     */
